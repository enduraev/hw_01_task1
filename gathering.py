...
def convert_data_to_table_format():
    ...
    with open(SCRAPPED_FILE) as json_data:
...
def stats_of_data():
    ...
    print(df2.sort_values('counts'))

    print('\n***Status on "Bicycle theft" crimes:')
    df2 = df[df.category == 'bicycle-theft'].groupby(['outcome_status']).size().reset_index(name='counts')
    print(df2, '\n')
